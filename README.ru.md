...
# 6. Начинай
# Вставь URL вакансии или запусти /career
```
...
```
/career                       → Показать все доступные команды
/career {вставь описание JD}  → Полный авто-пайплайн (оценка + PDF + трекер)
/career scan                  → Сканирование порталов
/career pdf                   → Генерация ATS-резюме
/career batch                 → Пакетная оценка вакансий
/career tracker               → Статус откликов
/career apply                 → Заполнение форм отклика с ИИ
/career pipeline              → Обработка очереди URL
/career contacto              → Сообщение в LinkedIn
/career deep                  → Глубокий анализ компании
/career training              → Оценка курса/сертификации
/career project               → Оценка портфолио-проекта
```

Или просто вставь URL вакансии — career автоматически определит его и запустит полный пайплайн.
...
**career — локальный open-source инструмент, НЕ хостинг-сервис.** Используя это ПО, вы подтверждаете:
