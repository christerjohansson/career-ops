...
# career batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
career batch runner — process job offers in batch via claude -p workers
