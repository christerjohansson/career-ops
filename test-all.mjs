...
/**
 * test-all.mjs — Comprehensive test suite for career
 *
...
const expectedModes = [
  '_shared.md', '_profile.template.md', 'eval.md', 'pdf.md', 'scan.md',
  'batch.md', 'apply.md', 'auto-pipeline.md', 'contacto.md', 'deep.md',
  'evals.md', 'pipeline.md', 'project.md', 'tracker.md', 'training.md',
];
