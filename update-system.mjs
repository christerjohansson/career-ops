...
/**
 * update-system.mjs — Safe auto-updater for career
 *
...
const CANONICAL_REPO = 'https://github.com/santifer/career.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/santifer/career/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/santifer/career/releases/latest';
