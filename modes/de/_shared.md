# Geteilter Kontext -- career (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle career-Modi
     in der deutschen Variante. Bevor du career verwendest, MUSST du:
