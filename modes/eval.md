...
- If FDE → prioritize proof points of rapid delivery and client-facing
...
1. **Detected level** in JD vs **natural level of the candidate for that archetype**
2. **"Sell senior without lying" plan**: archetype-specific phrases, concrete achievements to highlight, how to position founder experience as advantage
...
- Red-flag questions and how to answer them (e.g., "why did you sell your company?", "do you have reports?")
...
### 3. Generate PDF (if auto-pipeline)

If running full auto-pipeline, generate ATS-optimized PDF using the CV template.

---

## Score Format

At the end of the report, score from 0-5 with:
- 0-2: Don't apply
- 2-3: Apply if no better options
- 3-4: Good option, apply
- 4-5: Excellent, apply ASAP

Include:
- Recommended actions (apply, skip, negotiate)
- Links to generated files (PDF, report)