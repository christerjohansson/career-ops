...
<!-- ============================================================
     ...
     Перед использованием career убедитесь:
...
7. **Язык общения:** ВСЕГДА отвечай пользователю на английском языке (English), даже если промпт или вакансия на другом языке.
8. Быть прямым и конкретным — без воды
