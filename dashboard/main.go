...
import (
	...
	"github.com/santifer/career/dashboard/internal/data"
	"github.com/santifer/career/dashboard/internal/model"
	"github.com/santifer/career/dashboard/internal/theme"
	"github.com/santifer/career/dashboard/internal/ui/screens"
)
...
func main() {
	pathFlag := flag.String("path", ".", "Path to career directory")
	flag.Parse()
